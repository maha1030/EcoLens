...
function Navbar() {
return ( <header className="border-b border-gray-800 bg-[#0B0F0D]/80 backdrop-blur-md"> <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
